...
#  --------------------------------------------
from CalEffectiveProb_spurs import *

def ActionDecisionBottomSpurs(prob, money, jetton, bet, totalPot, stage, playerNum, currentGameNum, isButton, raiseInfo, totalNum, ACIB, smallBlind, blindInfo, checkEnable): 
    import random
    ...
    if stage == 1:
        ...
        if (totalNum == 2):
            ...
            if (myTotalMoney - enemyTotalMax) > SBAdjustRate * (20 + 10 * (600 - currentGameNum)):
                return "fold"
            elif (myTotalMoney - enemyTotalMin) < 0 and currentGameNum > 500:
                if prob >= 1:
                    prob = prob + 1
                else:
                    prob = prob + 0
